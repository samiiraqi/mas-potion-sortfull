      ...
      <svg width={BOTTLE_WIDTH} height={BOTTLE_HEIGHT} style={{ overflow: 'visible' }}>
        <defs>
          ...
          <linearGradient id={`lab-glass-${position.x}-${position.y}`} x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="rgba(224,247,250,0.4)" />
            <stop offset="50%" stopColor="rgba(178,235,242,0.5)" />
            <stop offset="100%" stopColor="rgba(128,222,234,0.3)" />
          </linearGradient>

          {/* Elegant Erlenmeyer flask shape */}
